  ...
  const validate = React.useCallback(
    (nextMode, nextForm) => {
      ...
      if (nextMode === 'register' && !nextForm.role) {
        nextErrors.role = t('auth.errors.roleRequired')
      }
              ...
              {loading ? (
                ...
                <form className="relative z-10 space-y-6" onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="space-y-2.5">
                    <label className={fieldLabelClass}>{t('auth.emailLabel')}</label>
                  ...
                  <div className="space-y-2.5">
                    <label className={fieldLabelClass}>{t('auth.passwordLabel')}</label>
                  ...
                  {mode === 'register' ? (
                    <div className="space-y-2.5">
                      <label className={fieldLabelClass}>{t('auth.roleLabel')}</label>
                      <Select value={form.role} onValueChange={(value) => setField('role', value)}>
                        ...
                        <SelectContent className="rounded-2xl border-black/10 bg-white/90 shadow-[0_24px_60px_rgba(15,23,42,0.16)] backdrop-blur-xl dark:border-white/10 dark:bg-zinc-950/90">
                          <SelectItem value="Student" className="rounded-xl text-base hover:bg-primary/10 aria-selected:bg-primary/10">{t('auth.student')}</SelectItem>
                          <SelectItem value="Mentor" className="rounded-xl text-base hover:bg-primary/10 aria-selected:bg-primary/10">{t('auth.mentor')}</SelectItem>
                        </SelectContent>
                      </Select>
